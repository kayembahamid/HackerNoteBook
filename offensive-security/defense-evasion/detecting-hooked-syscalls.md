...
{% content-ref url="../code-and-process-injection/windows-api-hooking.md" %}
[windows-api-hooking.md](../code-and-process-injection/windows-api-hooking.md)
{% endcontent-ref %}
...
{% content-ref url="../code-and-process-injection/api-monitoring-and-hooking-for-offensive-tooling.md" %}
[api-monitoring-and-hooking-for-offensive-tooling.md](../code-and-process-injection/api-monitoring-and-hooking-for-offensive-tooling.md)
{% endcontent-ref %}
...
![](https://386337598-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LFEMnER3fywgFHoroYn%2F-MOVVIkNJYxLhVM6ymrl%2F-MOXpYvCDgMM9lOs-_T1%2Fimage.png?alt=media\&token=28b25f14-0233-4c90-a1a8-1194f2cb444e)
...
![](https://386337598-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LFEMnER3fywgFHoroYn%2F-MOVVIkNJYxLhVM6ymrl%2F-MOXqBklIIe7S73PRkV5%2Fimage.png?alt=media\&token=72544c54-80d4-4d5b-8a86-34fc3df3899b)
...
![](https://386337598-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LFEMnER3fywgFHoroYn%2F-MOVVIkNJYxLhVM6ymrl%2F-MOXpPEc0c5SRBbm3bMq%2Fimage.png?alt=media\&token=66e6da37-afdb-459b-af20-b99e9823d7e1)
...
![Hooked and unhooked functions](https://386337598-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LFEMnER3fywgFHoroYn%2F-MOVVIkNJYxLhVM6ymrl%2F-MOY-SBC3WZsNpeDmar_%2Fimage.png?alt=media\&token=d758a9fb-5b36-45f4-9987-f55074616a36)
...
![Usual suspects hooked + some false positives](https://386337598-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LFEMnER3fywgFHoroYn%2F-MOY41nnsOSklf8CzCpb%2F-MOgazQOvSjBLSjdgamy%2Fimage.png?alt=media\&token=73fad11c-f39d-4b62-ae4b-6dbde31cb190)

### Updates

After I've posted this note on my twitter, I got a message from someone who is smarter than I am suggesting to check if the `syscall` instruction itself is not hooked. The `syscall` handler routine (responsible for locating functions in the [SSDT](https://www.ired.team/miscellaneous-reversing-forensics/windows-kernel-internals/glimpse-into-ssdt-in-windows-x64-kernel) based on a syscall number) location can be found by reading the Model Specific Register (MSR) at location `0xc0000082` and confirming that the address stored there points to `nt!KiSystemCall64Shadow`.
...
![](https://386337598-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LFEMnER3fywgFHoroYn%2F-MOpWAgSwxkMkJtHWOjq%2F-MOq-ESRr6BsAmphfUPg%2Fimage.png?alt=media\&token=11a6eb56-3214-4372-aed8-1b8cca90ddf2)
