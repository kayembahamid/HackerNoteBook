...
{% hint style="warning" %}
Note that in order to inject more complex PEs, additional DLLs in the target process may need to be loaded and Import Address Table fixed and for this, refer to my other lab [Reflective DLL Injection.](reflective-dll-injection.md)
{% endhint %}
...
7. Relocate/rebase the PE that's stored in `localImage` to `targetImage`. For more information about image relocations, see my other lab [T1093: Process Hollowing and Portable Executable Relocations](process-hollowing-and-portable-executable-relocations.md)
...
![](https://386337598-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LFEMnER3fywgFHoroYn%2F-Lsd7n0Mh6VudboWLRPC%2F-Lsd8iIJrevU8QE54FX1%2Fimage.png?alt=media\&token=e2e09b14-1b52-411c-9b74-e65b5e2296b2)
...
![](https://386337598-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LFEMnER3fywgFHoroYn%2F-Lsd7n0Mh6VudboWLRPC%2F-Lsd981DZA1jspJb4rT0%2Fimage.png?alt=media\&token=0a85429a-0e9e-42f0-a3a8-095f7838b127)

Let's allocate a new block of memory in the target process. In my case it got allocated at `0x000001bfc0c20000`:

![](https://386337598-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LFEMnER3fywgFHoroYn%2F-Lsd7n0Mh6VudboWLRPC%2F-Lsd9OGbXNJWqKMJ-BJG%2Fimage.png?alt=media\&token=4a715e4a-ee81-48e4-8ac0-6edf8fd2e3a6)

Calculate the delta between `0x000001bfc0c20000` and `0x000001813acc0000` and perform [image base relocations](https://www.ired.team/offensive-security/process-hollowing-and-pe-image-relocations#relocation). Once that's done, we can move over our rebased PE from `0x000001813acc0000` to `0x000001bfc0c20000` in the remote process using `WriteProcessMemory`.

Below shows that our imaged has now been moved to the remote process:

![](https://386337598-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LFEMnER3fywgFHoroYn%2F-Lsd7n0Mh6VudboWLRPC%2F-LsdAJxDnLO9kXR8_P_3%2Fimage.png?alt=media\&token=57b3b389-4252-477d-a844-542359b5d2a0)
...
![New thread getting created inside notepad.exe](https://386337598-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LFEMnER3fywgFHoroYn%2F-Lsd7n0Mh6VudboWLRPC%2F-LsdAp7UbzQmov_J294-%2Fnewthread.gif?alt=media\&token=51357f68-5f0f-4eb1-9404-3babb25a20d5)
...
![](https://386337598-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LFEMnER3fywgFHoroYn%2F-LsX8sRbCsj5qzdSe06x%2F-LsXCNWYHoFg4LmWOTQl%2Fpe-injection.gif?alt=media\&token=b730d6ec-336b-4c88-a172-07c2913b0998)
