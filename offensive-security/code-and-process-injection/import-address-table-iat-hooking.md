...
{% content-ref url="windows-api-hooking.md" %}
[windows-api-hooking.md](windows-api-hooking.md)
{% endcontent-ref %}
...
{% content-ref url="../../reversing-forensics-and-misc/internals/parsing-pe-file-headers-with-c++.md" %}
[parsing-pe-file-headers-with-c++.md](../../reversing-forensics-and-misc/internals/parsing-pe-file-headers-with-c++.md)
{% endcontent-ref %}
