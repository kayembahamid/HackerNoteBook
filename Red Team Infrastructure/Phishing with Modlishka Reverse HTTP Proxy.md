...
![](../../../../assets/Phishing%20with%20Modlishka%20Reverse%20HTTP%20Proxy.png)
...
![](../../../../assets/Phishing%20with%20Modlishka%20Reverse%20HTTP%20Proxy-1.png)
## Modlishka Configuration

Let's create a configuration file for modlishka:

![](../../../../assets/Phishing%20with%20Modlishka%20Reverse%20HTTP%20Proxy-2.png)
...
![](../../../../assets/Phishing%20with%20Modlishka%20Reverse%20HTTP%20Proxy-3.png)
We need to create a DNS TXT record in the DNS management console for redteam.me, which in my case is in Digital Ocean:

![](../../../../assets/Phishing%20with%20Modlishka%20Reverse%20HTTP%20Proxy-4.png)
Once the DNS TXT record is created, continue with the certificate generation:

![](../../../../assets/Phishing%20with%20Modlishka%20Reverse%20HTTP%20Proxy-5.png)
...
![](../../../../assets/Phishing%20with%20Modlishka%20Reverse%20HTTP%20Proxy-6.png)
...
![](../../../../assets/Phishing%20with%20Modlishka%20Reverse%20HTTP%20Proxy-7.png)
## More DNS Records

Let's create an A record for the root host `@` that simply points to the droplet's IP:

![](../../../../assets/Phishing%20with%20Modlishka%20Reverse%20HTTP%20Proxy-8.png)
This is very important - we need a `CNAME` record for any host/subdomain `*` pointing to `@`

![](../../../../assets/Phishing%20with%20Modlishka%20Reverse%20HTTP%20Proxy-9.png)
## Launching Modlishka
...
![](../../../../assets/modlishka.gif)

## References

[GitHub - drk1wi/Modlishka: Modlishka. Reverse Proxy. GitHub](https://github.com/drk1wi/Modlishka)
