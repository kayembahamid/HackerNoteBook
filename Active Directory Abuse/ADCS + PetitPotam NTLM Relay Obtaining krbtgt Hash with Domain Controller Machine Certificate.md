...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate.png)
## Domain Takeover
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-1.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-2.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-3.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-4.png)
### Finding Certificate Authority

On `WS01`, we can use a Windows LOLBIN `certutil.exe`, to find ADCS servers in the domain:

![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-5.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-6.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-7.png)
Above shows how:
...
>[! caution] Use `runas /netonly /user:fake powershell` to create a new/sacrificial logon session into which the `DC01$` TGT will be injected to prevent messing up TGTs/TGSs for your existing logon session.


![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-8.png)
`klist` confirms we now have a TGT for `DC01$` in the current logon session:

![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-9.png)
We can now perform [DCSync](https://www.ired.team/offensive-security-experiments/active-directory-kerberos-abuse/dump-password-hashes-from-domain-controller-with-dcsync) and pull the NTLM hash for the user `offsense\krbtgt`:


>
[DCSync: Dump Password Hashes from Domain Controller](/Users/macbook/Library/Mobile Documents/com~apple~CloudDocs/Obsidian Vault/1. Projects/CyberSec-Work/Pentest/Active Directory Abuse/DCSync  Dump Password Hashes from Domain Controller.md)


![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-10.png)
Having the NTLM hash for `krbtgt` allows us to create [Kerberos Golden Tickets](https://www.ired.team/offensive-security-experiments/active-directory-kerberos-abuse/kerberos-golden-tickets).


>   [kerberos-golden-tickets](/Users/macbook/Library/Mobile Documents/com~apple~CloudDocs/Obsidian Vault/1. Projects/CyberSec-Work/Pentest/Active Directory Abuse/Kerberos Golden Tickets.md)
>>
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-11.png)### Lab Setup
...
[Kerberos Resource-based Constrained Delegation: Computer object Takeover](/Users/macbook/Library/Mobile Documents/com~apple~CloudDocs/Obsidian Vault/1. Projects/CyberSec-Work/Pentest/Active Directory Abuse/Kerberos Resource-based Constrained Delegation Computer Object Takeover.md)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-12.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-13.png)
Below screenshot shows that the `QUAIIVEE` computer account has been indeed created and `WS01$` has some privileges to it:

![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-14.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-16.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-17.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-18.png)
### WebClient Service

For the above attack to work, the target system `WS01` has to have the `WebClient` service running:

![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-19.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-20.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-21.png)

>[!tip] Ability to create machine accounts applies when talking about remote computer takeover too.
...
* 10.0.0.5 - Kali box with NTLM relay;
* 10.0.0.7 - Windows worksation `WS01`. This is the box we will coerce to authenticate our Kali box, which will relay the authentication to `DC01` and setup the computer `WS01` for [RBCD attack](https://www.ired.team/offensive-security-experiments/active-directory-kerberos-abuse/resource-based-constrained-delegation-ad-computer-object-take-over-and-privilged-code-execution);
* 10.0.0.6 - Domain Controller `DC01`;
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-22.png)
### Impersonating Domain Admin on WS01
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-23.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-24.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-25.png)
...
![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-26.png)
...
```
![](assets/image%20(4).gif)


Privileged code execution on `WS01` can also be achieved using impacket's psexec:

![](assets/ADCS%20+%20PetitPotam%20NTLM%20Relay%20Obtaining%20krbtgt%20Hash%20with%20Domain%20Controller%20Machine%20Certificate-27.png)
...
[KB5005413: Mitigating NTLM Relay Attacks on Active Directory Certificate Services (AD CS) - Microsoft Supportsupport.microsoft.com](https://support.microsoft.com/en-us/topic/kb5005413-mitigating-ntlm-relay-attacks-on-active-directory-certificate-services-ad-cs-3612b773-4043-4aa9-b23d-b87910cd3429)
...
[Red Team Privilege Escalation - RBCD Based Privilege Escalation - Part 2 Praetorian](https://www.praetorian.com/blog/red-team-privilege-escalation-rbcd-based-privilege-escalation-part-2/)

[Research in Cybersecurity orangecyberdefense.com](https://orangecyberdefense.com/global/blog/sensepost/chaining-multiple-techniques-and-tools-for-domain-takeover-using-rbcd/)
