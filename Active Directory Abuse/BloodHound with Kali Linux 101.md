...
![](assets/BloodHound%20with%20Kali%20Linux%20101.png)
...
![](assets/BloodHound%20with%20Kali%20Linux%20101-1.png)
...
![](assets/BloodHound%20with%20Kali%20Linux%20101-2.png)
...
![](assets/BloodHound%20with%20Kali%20Linux%20101-3.png)
...
![](assets/Peek%202019-01-03%2018-44.gif)
...
![](assets/BloodHound%20with%20Kali%20Linux%20101-4.png)
...
![](assets/BloodHound%20with%20Kali%20Linux%20101-5.png)
### Example #3: User to Domain Admin via Weak ACEs

The below shows how the user spotless can become a Domain Admin by [abusing weak ACEs](https://www.ired.team/offensive-security-experiments/abusing-active-directory-acls-aces#genericall-on-group) of the said group. In this particular example, the user spotless can essentially add themselves to domain admins group with `net group "domain admins" spotless /add /domain` and it is gamer over:

![](assets/BloodHound%20with%20Kali%20Linux%20101-6.png)
...
[HomeGitHub]("<https://github.com/BloodHoundAD/BloodHound/wiki>")

[Abusing Active Directory ACLs/ACEs](obsidian://open?vault=Obsidian%20Vault&file=1.%20Projects%2FCyberSec-Work%2FPentest%2FActive%20Directory%20Abuse%2FAbusing%20Active%20Directory%20ACLs%20ACEs)