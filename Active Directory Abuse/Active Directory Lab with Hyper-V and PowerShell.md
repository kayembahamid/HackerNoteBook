...
![](assets/Active%20Directory%20Lab%20with%20Hyper-V%20and%20PowerShell.png)
...
>[!important ] You may need to change the passwords depending on your password policies.
...
![](assets/Active%20Directory%20Lab%20with%20Hyper-V%20and%20PowerShell-1.png)

>[! note] Don't forget to run `gpupdate.exe` on the `DC01` for the new password policy to take affect. This step is mandatory before running `Create-Users.ps1` script, otherwise the user passwords will not be changed.
