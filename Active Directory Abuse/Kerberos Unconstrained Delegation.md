...
![](assets/Kerberos%20Unconstrained%20Delegation.png)
...
![](assets/Kerberos%20Unconstrained%20Delegation-1.png)
## Execution
...
![](assets/Kerberos%20Unconstrained%20Delegation-2.png)
...
![](assets/Kerberos%20Unconstrained%20Delegation-3.png)
...
![](assets/Kerberos%20Unconstrained%20Delegation-4.png)
...
![](assets/Kerberos%20Unconstrained%20Delegation-10.png)
...
![](assets/Kerberos%20Unconstrained%20Delegation-6.png)
...
![](assets/Kerberos%20Unconstrained%20Delegation-7.png)
Once the TGT is imported on IIS01, let's check available tickets and try connecting to the `DC01` again:

![](assets/Kerberos%20Unconstrained%20Delegation-8.png)
...
![](assets/Kerberos%20Unconstrained%20Delegation-9.png)
## Mitigation
...
Active Directory & Azure AD/Entra ID Security  {% embed url="<https://adsecurity.org/?p=1667>" %}

 Kerberos AD Attacks - Kerberoasting {% embed url="<https://blog.xpnsec.com/kerberos-attacks-part-1/>" %}

Kerberos for the Busyy Admin {% embed url="<https://blogs.technet.microsoft.com/askds/2008/03/06/kerberos-for-the-busy-admin/>" %}
