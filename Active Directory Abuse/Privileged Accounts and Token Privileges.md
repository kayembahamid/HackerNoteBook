...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges.png)
However, we can still add new users:

![](assets/Privileged%20Accounts%20and%20Token%20Privileges-1.png)
As well as login to DC01 locally:

![](assets/Privileged%20Accounts%20and%20Token%20Privileges-2.png)
## Server Operators
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-3.png)
However, if the user belongs to `Server Operators`:

![](assets/Privileged%20Accounts%20and%20Token%20Privileges-4.png)
The story changes:

![](assets/Privileged%20Accounts%20and%20Token%20Privileges-5.png)
## Backup Operators

As with `Server Operators` membership, we can access the `DC01` file system if we belong to `Backup Operators`:

![](assets/Privileged%20Accounts%20and%20Token%20Privileges-6.png)
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-7.png)
`Whoami /priv` shows the privilege is disabled by default:

![](assets/Privileged%20Accounts%20and%20Token%20Privileges-8.png)
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-9.png)
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-10.png)
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-11.png)
## GPO Delegation
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-12.png)
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-13.png)
More about general AD ACL/ACE abuse refer to the lab:

{% content-ref url="abusing-active-directory-acls-aces" %}
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-14.png)
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-15.png)
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-16.png)
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-17.png)
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-18.png)
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-19.png)
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-20.png)
### Force Policy Update
...
![](assets/Privileged%20Accounts%20and%20Token%20Privileges-21.png)
### Under the hood

If we observe the Scheduled Tasks of the `Misconfigured Policy` GPO, we can see our `evilTask` sitting there:

![](assets/Privileged%20Accounts%20and%20Token%20Privileges-22.png)
...
MicrosoftLearn{% embed url="<https://docs.microsoft.com/en-us/windows-server/identity/ad-ds/plan/security-best-practices/appendix-b--privileged-accounts-and-groups-in-active-directory>" %}


**Enabling and Disabling Privileges in C++ - Win32 apps **
MicrosoftLearn{% embed url="<https://docs.microsoft.com/en-us/windows/desktop/secauthz/enabling-and-disabling-privileges-in-c-->" %}

**Scanning for Active Directory Privileges & Privileged Accounts **
Active Directory & Azure AD/Entra ID Security{% embed url="<https://adsecurity.org/?p=3658>" %}
...
Tarlogic Security{% embed url="<https://www.tarlogic.com/en/blog/abusing-seloaddriverprivilege-for-privilege-escalation/>" %}
...
**A Red Teamer’s Guide to GPOs and OUs - SpecterOps **
SpecterOps{% embed url="<https://posts.specterops.io/a-red-teamers-guide-to-gpos-and-ous-f0d03976a31e>" %}

**NTAPI Undocumented Functions **
SpecterOps{% embed url="<https://undocumented.ntinternals.net/index.html?page=UserMode%2FUndocumented%20Functions%2FExecutable%20Images%2FNtLoadDriver.html>" %}
