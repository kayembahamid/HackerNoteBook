...
![](../../../../assets/Kerberos%20Constrained%20Delegation.png)
The `msds-allowedtodelegate` attribute in AD is defined here:

![](../../../../assets/Kerberos%20Constrained%20Delegation-1.png)
The `TRUSTED_TO_AUTH_FOR_DELEGATION` attribute in AD is defined here:

![](../../../../assets/Kerberos%20Constrained%20Delegation-2.png)
### Execution
...
![](../../../../assets/Kerberos%20Constrained%20Delegation-3.png)
...
![](../../../../assets/Kerberos%20Constrained%20Delegation-4.png)
...
![](../../../../assets/Kerberos%20Constrained%20Delegation-5.png)

We've got the impersonated TGS tickets for administrator account:

![](../../../../assets/Kerberos%20Constrained%20Delegation-6.png)
...
![](../../../../assets/Kerberos%20Constrained%20Delegation-7.png)
...
![](../../../../assets/Kerberos%20Constrained%20Delegation-8.png)
...
![](../../../../assets/Kerberos%20Constrained%20Delegation-9.png)
...
![](../../../../assets/Kerberos%20Constrained%20Delegation-10.png)
...
![](../../../../assets/Kerberos%20Constrained%20Delegation-11.png)
...
![](../../../../assets/Kerberos%20Constrained%20Delegation-12.png)
## References
...
**MicrosoftLearn** {% embed url="<https://blogs.msdn.microsoft.com/mattlind/2010/01/13/delegation-tab-in-aduc-not-available-until-a-spn-is-set/>" %}

**KDC_ERR_BADOPTION when attempting constrained delegation**
**MicrosoftLearn** {% embed url="<https://blogs.technet.microsoft.com/tristank/2007/06/18/kdc_err_badoption-when-attempting-constrained-delegation/>" %}

**UserAccountControl property flags - Windows Server**
**MicrosoftLearn** {% embed url="<https://support.microsoft.com/en-gb/help/305144/how-to-use-useraccountcontrol-to-manipulate-user-account-properties>" %}
