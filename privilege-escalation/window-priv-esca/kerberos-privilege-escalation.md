...
#### 1. Check User's Permission and Windows Versions <a href="#id-1-check-users-permission-and-windows-versions" id="id-1-check-users-permission-and-windows-versions"></a>
...
#### 2. Create a New Computer <a href="#id-2-create-a-new-computer" id="id-2-create-a-new-computer"></a>
...
#### 3. Impersonate to Get a Ticket <a href="#id-3-impersonate-to-get-a-ticket" id="id-3-impersonate-to-get-a-ticket"></a>
...
#### 4. Make the Ticket Usable and Use It <a href="#id-4-make-the-ticket-usable-and-use-it" id="id-4-make-the-ticket-usable-and-use-it"></a>

Download “ticket\_converter.py”.
