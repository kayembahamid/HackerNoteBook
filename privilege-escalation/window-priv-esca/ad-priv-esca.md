...
\&#xNAN;_account, extract the encrypted blob that was encrypted using the user's password and bruteforce it offline._
...
\&#xNAN;_blob and bruteforce it offline._
