...
### GTFOBins <a href="#gtfobins" id="gtfobins"></a>
...
#### As Another Users <a href="#as-another-users" id="as-another-users"></a>
...
#### List Privileges Commands <a href="#list-privileges-commands" id="list-privileges-commands"></a>
...
### Edit Sudoers <a href="#edit-sudoers" id="edit-sudoers"></a>
...
### Command Forgery (NOPASSWD) <a href="#command-forgery-nopasswd" id="command-forgery-nopasswd"></a>
...
### Command Forgery (SETENV, NOPASSWD) <a href="#command-forgery-setenv-nopasswd" id="command-forgery-setenv-nopasswd"></a>
...
### Shell in Prompt <a href="#shell-in-prompt" id="shell-in-prompt"></a>
...
### Reuse Sudo Tokens <a href="#reuse-sudo-tokens" id="reuse-sudo-tokens"></a>
