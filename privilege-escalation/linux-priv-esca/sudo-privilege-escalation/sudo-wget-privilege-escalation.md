...
### Modify /etc/shadow <a href="#modify-etcshadow" id="modify-etcshadow"></a>
...
#### 1. Get the Content of /etc/shadow <a href="#id-1-get-the-content-of-etcshadow" id="id-1-get-the-content-of-etcshadow"></a>
...
#### 2. Create a New Shadow File <a href="#id-2-create-a-new-shadow-file" id="id-2-create-a-new-shadow-file"></a>
...
#### 3. Create a New Root User Password and Add to Shadow File <a href="#id-3-create-a-new-root-user-password-and-add-to-shadow-file" id="id-3-create-a-new-root-user-password-and-add-to-shadow-file"></a>
...
#### 4. Transfer the Content of the Shadow File <a href="#id-4-transfer-the-content-of-the-shadow-file" id="id-4-transfer-the-content-of-the-shadow-file"></a>
