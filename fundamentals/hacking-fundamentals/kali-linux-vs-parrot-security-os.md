...
### <mark style="color:blue;">What's an OS (operating system) ?</mark>
...
<figure><img src="https://static.javatpoint.com/operating-system/images/history-of-the-operating-system.png" alt="" width="375"><figcaption></figcaption></figure>

### <mark style="color:blue;">Type of OS</mark>
...
### <mark style="color:blue;">Why Linux ?</mark>
...
### <mark style="color:blue;">Why Kali ?</mark>
...
{% embed url="https://www.youtube.com/watch?v=XzD8JIAOk2I&pp=ygULa2FsaSBpbnRhbGw%3D" %}

### <mark style="color:blue;">Kali Linux vs Parrot Security OS</mark>
...
[**Parrot Security OS:**](https://help.hackthebox.com/en/articles/6369713-installing-parrot-security-on-a-vm)
...
{% embed url="https://www.kali.org/get-kali/#kali-cloud" %}

### <mark style="color:blue;">Free Cloud Services (with Some limitation)</mark>

#### <mark style="color:blue;">Google Shell Cloud</mark>
...
{% embed url="https://shell.cloud.google.com/" %}

#### <mark style="color:blue;">TryHackMe Cloud</mark>
...
#### <mark style="color:blue;">HTB Academy Cloud</mark>
...
### What Does USB Boot Mean? <a href="#what-does-usb-boot-mean" id="what-does-usb-boot-mean"></a>
...
{% embed url="https://www.youtube.com/watch?v=FYYU9qZ0Pps" %}
...
{% embed url="https://www.youtube.com/watch?v=gd7BXuUQ91w&t=219s&pp=ygUpbXVzdCBsZWFybiBsaW51eCBjb21tYW5kIG5vdyBuZXR3b3JrY2h1Y2s%3D" %}
...
### Linux Basics for Hackers <a href="#title" id="title"></a>
