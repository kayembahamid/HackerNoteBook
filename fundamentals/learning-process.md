---
description: It would be impossible for any one person to learn everything
---
...
<i class="fa-question-circle">:question-circle:</i>**Optional Exercise:**
...
{% hint style="success" %}
[Talent is a trained and adapted thought process and the associated thought patterns for specific fields and situations.](#user-content-fn-1)[^1]
{% endhint %}
