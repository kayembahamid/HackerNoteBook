...
The binary number `10101010` represents:`128 + 0 + 32 + 0 + 8 + 0 + 2 + 0 = 170` (decimal).
...
The binary number `11111111` represents:`F` (first quartet) + `F` (second quartet) = `FF` (hexadecimal).
...
The binary number `11010110` represents:`110` (6) + `101` (5) + `10` (2, with leading zero added) = `652` (octal).
