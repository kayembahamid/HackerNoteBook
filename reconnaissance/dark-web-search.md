...
* [http://nekhbet.com/i2p\_links.shtml](http://nekhbet.com/i2p_links.shtml) - A neatly organized directory of eepsites.
...
* [Tor2Web ](https://tor2web.org/)- Tor2web is a software project to allow [Tor hidden services](https://en.wikipedia.org/wiki/List_of_Tor_hidden_services) to be accessed from a standard [browser](https://en.wikipedia.org/wiki/Web_browser) without being connected to the [Tor network](https://en.wikipedia.org/wiki/Tor_\(anonymity_network\))
